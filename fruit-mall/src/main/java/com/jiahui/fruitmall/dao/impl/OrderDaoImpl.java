...
import com.jiahui.fruitmall.rowapper.OrderItemRowMapper;
import com.jiahui.fruitmall.rowapper.OrderRowMapper;
...
//        //使用 forloop   一條一條數據 加入 SQL 效率低
//        for(  OrderItem orderItem :orderItemList){
//
//            //sql
//            String sql="INSERT INTO order_item(order_id,product_id,quantity,amount) "+
//                        "VALUES (:orderId,:productId,:quantity,:amoutn)";
//
//            Map<String,Object>map=new HashMap<>();
//            map.put("orderId",orderId);
//            map.put("productId",orderItem.getProductId());
//            map.put("quantity",orderItem.getQuantity());
//            map.put("amoutn",orderItem.getAmount());
//
